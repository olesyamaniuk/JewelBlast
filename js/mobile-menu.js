document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".w-u-navigation-list");
  const headerRef = document.querySelector(".w-u-header");
  const navigationRef = document.querySelector(".w-u-navigation");
